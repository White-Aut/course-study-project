...
class User(Base):
    ...
    gender: Mapped[Optional[str]] = mapped_column(Enum("male", "female"), comment="性别",default="male")
    bio: Mapped[Optional[str]] = mapped_column(String(500), comment="个人简介", default="这个人很懒，什么都没有留下。")
    phone: Mapped[Optional[str]] = mapped_column(String(11), comment="手机号", unique=True)
